...
public class Mail {
   ...
   */
  public Mail(final Map<String, String> headerMap, final String template) {
  ...
  private String generate() {
    ...
    for (Map.Entry<String, String> ignored : headerMap.entrySet()) {
//      System.out.println("Key = " + entry.getKey() + ", Value = " + entry.getValue());
      final Pattern pattern = Pattern.compile("\\[\\[(.*?)\\]\\]");
      final Matcher matcher = pattern.matcher(generatedStr);
      while (matcher.find()) {
