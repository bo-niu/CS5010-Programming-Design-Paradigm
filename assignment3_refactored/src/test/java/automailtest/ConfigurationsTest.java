...
public class ConfigurationsTest {
  ...
  public void testEquals() {
    ...
    final Configurations configurations2 = new Configurations(MailType.EMAIL, "template.txt",
        "testCSV.csv", "output", null);
    final Configurations configurations3 = new Configurations(MailType.LETTER, "template2.txt",
        "testCSV.csv", "output", null);
    final Configurations configurations4 = new Configurations(MailType.LETTER, "template.txt",
        "testCSV2.csv", "output", null);
    final Configurations configurations5 = new Configurations(MailType.LETTER, "template.txt",
        "testCSV.csv", "output2", null);
