 ...
 */
public class YossarianQuarterSize extends AbstractYossarian {

  /**
   * Constructor of the YossarianQuarterSize class.
   *
   ...
   */
  public YossarianQuarterSize(final FurnitureColor furnitureColor,
