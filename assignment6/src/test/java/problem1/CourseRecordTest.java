...
public class CourseRecordTest {
    ...
    private CourseRecord course1, course2;

    @Before
    public void setUp() throws Exception {
        course1 = new CourseRecord("AAA", "S17", 155);
        course2 = new CourseRecord("BBB", "S18");
        course2.setLength(128);
    }
    ...
    public void testEquals() {
        ...
        CourseRecord course3 = new CourseRecord("AAA", "S17", 155);
