...
/**
 * Course class representing each course in course.csv and studentV.csv.
 */
public class Course {
     ...
     */
    public Course(String module, String presentation, Integer length) {
        this.module = module;
     ...
     * @param presentation a string representing this Course's presentation.
     */
    public Course(String module, String presentation) {
        this.module = module;
        this.presentation = presentation;
    }
